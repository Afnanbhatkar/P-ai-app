        ...
        <>
                        ...
                        return (
                          <div
                            ...
                            onClick={() => {
                              ...
                              localStorage.setItem("currentChatId", String(chat.id));  // ⭐ FIX: persist selected chat
                              setMessages(
                                (chat.messages || []).map((m) => ({
          ...
          <div className={`fixed top-0 left-0 right-0 h-16 bg-orange-50 backdrop-blur-md z-30 flex items-center justify-between px-6 transition-all duration-500 ${sidebarOpen ? "ml-64" : "ml-0"}`}>
            <h1 className="text-2xl font-bold text-emerald-800 ">
              Abian <span className="text-gray-500 text-sm font-normal">1.2</span>
            </h1>
                    ...
                    <div className={`max-w-2xl px-4 py-4 rounded-3xl ${msg.from === "user" ? "bg-[#fcf2e6] text-black" : "text-[#53493a]"}`}>
                      {msg.from === "bot" && (
                        <div className="flex items-center gap-3 mb-2">
                          <div className="w-8 h-8 rounded-md bg-[#e9dfc8] flex items-center justify-center font-bold text-green-800">AB</div>
                          <strong></strong>
                        </div>
                      )}
